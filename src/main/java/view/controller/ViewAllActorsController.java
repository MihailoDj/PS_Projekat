...
public class ViewAllActorsController {
        ...
        frmViewActors.getBtnDetailsAddActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (row != -1) {
                    ...
                    MainCoordinator.getInstance().addParam(Constants.PARAM_ACTOR, actor);
                    MainCoordinator.getInstance().openActorDetailsForm();
                } else {
    ...
    public void openForm() {
        prepareView();
        frmViewActors.setLocationRelativeTo(MainCoordinator.getInstance().getMainContoller().getFrmMain());
