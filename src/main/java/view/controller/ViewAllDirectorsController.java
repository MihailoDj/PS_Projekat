...
public class ViewAllDirectorsController {
        ...
        frmViewDirectors.getBtnDetailsAddActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (row != -1) {
                    ...
                    MainCoordinator.getInstance().addParam(Constants.PARAM_DIRECTOR, director);
                    MainCoordinator.getInstance().openDirectorDetailsForm();
                } else {
    ...
    public void openForm() {
        prepareView();
        frmViewDirectors.setLocationRelativeTo(MainCoordinator.getInstance().getMainContoller().getFrmMain());
